# Description
Testing a complex with a not-bound condition for generating a model using KamiAssembler.
...
mek_no_braf = Agent('MAP2K1', bound_conditions=[BoundCondition(braf, False)], db_refs={'HGNC': '6840'})
