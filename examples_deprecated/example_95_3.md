# Description
Test assembling an indirect phosphorylation statement into an Index Card and validating it against a JSON schema.
...
ev2 = Evidence(source_api='reach', text='BRAF phosphorylates MAP2K1.', pmid='22833081', epistemics={'direct': False})
