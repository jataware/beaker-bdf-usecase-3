# Description
The provided code demonstrates how to create a function decorator `perm_cache` which caches the results of a function call to a file. It supports both binary (`.pkl`) and JSON (`.json`) file formats for caching.
