# Description
Process host-virus interactions from the VirHostNet website using a query to constrain the results to a subset of the VirHostNet database.
...
vhn_url = ('http://virhostnet.prabi.fr:9090/psicquic/webservices/current/search/query/')
